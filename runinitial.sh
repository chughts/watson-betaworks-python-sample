...
echo "from django.contrib.auth.models import User; User.objects.create_superuser(username='xxxxxxxx',password='yyyyyyyy',email='aaaaa@bbb.com')" | python manage.py shell --settings=cognitive.settings.bluemix
